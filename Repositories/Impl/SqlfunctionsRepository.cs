...
{
    public class SqlfunctionsRepository: BaseEfRepository<Sqlfunctions>,ISqlfunctionsRepository
    {
        /// <summary>
        ///  获取 仓储上下文的实例
        /// </summary>
        ...
        public SqlfunctionsRepository(IUnitOfWork unitOfWork) : base(unitOfWork)
        {
