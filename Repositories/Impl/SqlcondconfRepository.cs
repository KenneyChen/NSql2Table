...
{
    public class SqlcondconfRepository: BaseEfRepository<Sqlcondconf>,ISqlcondconfRepository
    {
        /// <summary>
        ///  获取 仓储上下文的实例
        /// </summary>
        ...
        public SqlcondconfRepository(IUnitOfWork unitOfWork) : base(unitOfWork)
        {
