...
{
    public class DsconfigRepository: BaseEfRepository<Dsconfig>,IDsconfigRepository
    {
        /// <summary>
        ///  获取 仓储上下文的实例
        /// </summary>
        ...
        public DsconfigRepository(IUnitOfWork unitOfWork) : base(unitOfWork)
        {
