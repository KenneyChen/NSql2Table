...
{
    public class SqlresultconfRepository: BaseEfRepository<Sqlresultconf>,ISqlresultconfRepository
    {
        /// <summary>
        ///  获取 仓储上下文的实例
        /// </summary>
        ...
        public SqlresultconfRepository(IUnitOfWork unitOfWork) : base(unitOfWork)
        {
