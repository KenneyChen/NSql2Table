...
{
    public class SqltemlateRepository: BaseEfRepository<Sqltemlate>,ISqltemlateRepository
    {
        /// <summary>
        ///  获取 仓储上下文的实例
        /// </summary>
        ...
        public SqltemlateRepository(IUnitOfWork unitOfWork) : base(unitOfWork)
        {
