...
{
    public class SysconstRepository: BaseEfRepository<Sysconst>,ISysconstRepository
    {
        /// <summary>
        ///  获取 仓储上下文的实例
        /// </summary>
        ...
        public SysconstRepository(IUnitOfWork unitOfWork) : base(unitOfWork)
        {
