  ...
  <div class="userManagement-container">
    ...
    <el-table v-loading="listLoading"
      ...
      <el-table-column show-overflow-tooltip
                       prop="id"
                       label="报表名称"></el-table-column>
      <el-table-column show-overflow-tooltip
                       prop="code"
                       label="报表编码"></el-table-column>


      <el-table-column show-overflow-tooltip
                       prop="dbType"
                       :formatter="formatDbType"
...
<script>
  import { getList, doDelete } from '@/api/dataSource'
  import Edit from './components/DsEdit'
